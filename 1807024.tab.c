...
{
      12,     0,    -1,    13,    12,    -1,    -1,     4,    14,    10,
      -1,     3,    15,    10,    -1,     5,    16,    10,    -1,     9,
       7,     8,    10,    -1,    14,     6,     9,    -1,     9,    -1,
      15,     6,     9,    -1,     9,    -1,    16,     6,     9,    -1,
       9,    -1
};
...
{
  "$end", "error", "$undefined", "FLOAT", "INT", "CHAR", "COMMA",
  "ASSIGN", "NUM", "ID", "END", "$accept", "PROGRAM", "STATEMENT", "ID1",
  "ID2", "ID3", 0
};
#endif
...
{
       3,     0,     0,     0,     0,     0,     3,    11,     0,     9,
       0,    13,     0,     0,     1,     2,     0,     5,     0,     4,
       0,     6,     0,    10,     8,    12,     7
};
...
{
       1,     2,     3,     7,    16,    18,     4,    20,    17,    19,
      14,    21,     9,    11,    13,    23,    22,     0,    24,    15,
      25,     0,    26
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     9,     6,     6,     9,     6,    10,    10,
       0,    10,     9,     9,     7,     9,     8,    -1,     9,     6,
       9,    -1,    10
};
...
{
       0,     3,     4,     5,     9,    12,    13,     9,    15,     9,
      14,     9,    16,     7,     0,    12,     6,    10,     6,    10,
       6,    10,     8,     9,     9,     9,    10
};
...
#line 80 "1807024.y"
    {
								printf("%d",find_i(store_int,(yyvsp[(1) - (4)].string),in_int));
							;}
    break;
